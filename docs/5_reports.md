...
| Constant                          | Meaning                                                                                                                                                                                                                                                                                                                                                |
|-----------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `ACCOUNT_PARTY_MAPPING_CSV_PATH`  | Path to the party-account CSV. Lives in `reports/data/` folder.                                                                                                                                                                                                                                                                                        |
...
| `BEHAVIOUR_METRICS_CSV_PATH`      | Reference population CSV for behaviour comparisons (used for percentile baselines only). Donor metrics are computed from watch history. Lives in `reports/data/` folder. In production, ansible copies the data file directly to the `data` folder; thus if this file is updated, this also needs to be done in the infrastructure deployment scripts. |
